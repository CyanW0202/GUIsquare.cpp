CXXFLAGS += -I./mysql-connector-c++-8.0.12-linux-ubuntu18.04-x86-64bit/include/jdbc -I./mysql-connector-c++-8.0.12-linux-ubuntu18.04-x86-64bit/lib64/include/jdbc/cppconn 
...
output: Antenna.o BaseStation.o BSFailureParams.o DataRateTable.o EnvironmentController.o EnvironmentInitialization.o ErrorTracer.o UERecord.o FileIO.o \
	...
	GUIDataContainer.o GUIMain.o IRPManager.o NetworkLogBuffer.o Setup.o Simulator.o Transceivers.o Transmission.o UEDataBase.o UELogData.o UserEquipment.o -g -o output `pkg-config --cflags --libs gtk+-3.0` -lcurl -L./my-sql-connector-C++-8.0.12-linux-ubuntu18.04-x86-64bit/lib64 -lmysqlcppconn-static -lmysqlcppconn -L/usr/lib -lmysqlclient
...
FileIO.o: FileIO.cpp FileIO.h
	g++ -g -c FileIO.cpp `pkg-config --cflags --libs gtk+-3.0` -I./mysql-connector-c++-8.0.12-linux-ubuntu18.04-x86-64bit/include/jdbc -I./mysql-connector-c++-8.0.12-linux-ubuntu18.04-x86-64bit/lib64/include/jdbc/cppconn 
...
GUIMain.o: GUIMain.cpp GUIMain.h
	g++ -g -c GUIMain.cpp `pkg-config --cflags --libs gtk+-3.0` -I./curl/include -I./cjson/include
